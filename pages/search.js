        ...
        <div className="md:col-span-3">
          <div className="mb-2 flex items-center justify-between border-b-2 pb-2">
            <div className="flex items-center">
              {products.length === 0 ? "No" : countProducts} хайлтын үр дүн
            ...
            <div>
              ...
              <select value={sort} onChange={sortHandler}>
                <option value="featured">Онцгой</option>
                <option value="lowest">Үнэ багаас их</option>
                <option value="highest">Үнэ ихээс бага</option>
                <option value="toprated">Сэтгэгдэл</option>
